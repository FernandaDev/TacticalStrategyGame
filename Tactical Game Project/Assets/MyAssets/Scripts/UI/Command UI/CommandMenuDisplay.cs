...
public class CommandMenuDisplay : MonoBehaviour
{
    ...
    public void OnConfirmingCommand() => Display(confirmPanelTransform.gameObject, true);
    public void ShowMenu(bool showMenu) => Display(contentTransform.gameObject, showMenu);
    void Display(GameObject objectToDisplay, bool shouldDisplay) => objectToDisplay.SetActive(shouldDisplay);
